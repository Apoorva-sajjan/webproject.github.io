          ...
          <form action="book.php" method="POST">
            ...
            <div class="col-md-12 text-center" id="menu-filters">
              <ul class="ul-menus">
                ...
                <li><a class="filter " data-filter=".wine_bar">Non-Vegetarian</a></li>
                <li><a class="filter " data-filter=".bio">Pizza</a></li>
                <li><a class="filter " data-filter=".bistro_brass">Vegetarian</a></li>
                <li><a class="filter " data-filter=".waffles">Fast Food</a></li>
                <li><a class="filter " data-filter=".world_food">Traditional</a></li>
                <li><a class="filter " data-filter=".gourmet">Deserts</a></li>
