        ...
        <form action="book.php" method="POST">
          ...
          <div class="col-md-12 text-center" id="menu-filters">
            <ul>
              ...
              <li><a class="filter " data-filter=".menu">Roti</a></li>
              <li><a class="filter " data-filter=".entree">Curry</a></li>
              <li><a class="filter " data-filter=".dish">Rice</a></li>
              <li><a class="filter" data-filter=".sidedish">Starter</a></li>
